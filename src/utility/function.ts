import {
  RoleForActor,
  FilmForActorViewModel,
  Cast,
  ActorViewModel,
} from './class';

const normalizeFilmArray = (
  roleForActor: RoleForActor,
): FilmForActorViewModel[] => {
...
export const mergeFilm = (
  filmFromActor1: RoleForActor,
  filmFromActor2: RoleForActor,
) => {
  let filmsForFirstActor: FilmForActorViewModel[] = normalizeFilmArray(
    filmFromActor1,
  );
  let filmsForSecondActor: FilmForActorViewModel[] = normalizeFilmArray(
    filmFromActor2,
  );
